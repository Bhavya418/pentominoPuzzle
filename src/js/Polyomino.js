...
export const tetrominos = {
    'I': new Polyomino([[0, 0], [0, 1], [0, 2], [0, 3],[1, 1]]),
    'O': new Polyomino([[0, 0], [0, 1], [1, 1], [1, 0],[2,0]]),
    'T': new Polyomino([[0, 1], [0, 0], [1, 0], [2, 1],[2,0]]),
    'J': new Polyomino([[0, 0], [1, 0], [2, 0], [2, 1],[2,2]]),
    'L': new Polyomino([[0, 2], [1, 1], [2, 0], [0, 1],[1,0]]),
    'S': new Polyomino([[0, 0], [1, 0], [0, 1], [0, 2],[0,3]]),
    'Z': new Polyomino([[0, 1], [1, 1], [1, 0], [2, 0],[3,0]]),
    'P': new Polyomino([[0, 1], [1, 1], [1, 2], [1, 0],[2,1]]),
